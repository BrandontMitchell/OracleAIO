          ...
          <div id="editModal" className="edit__modal__inputs">
            ...
            <div id="editModal" className="input__full">
              <input
                ...
                onChange={e => this.handleChange(e, 'editLink')}
                placeholder="Keywords, URL, or Variant"
              />
            </div>
            <span id="editModal" className="input__text">
              Sizes
            ...
            <div className="input__split">
              <div className="input__half">
                ...
                <input
                  ...
                  onChange={e => this.handleChange(e, 'monitorDelay')}
                  placeholder="0"
                />
              </div>
              <div className="input__half">
                ...
                <input
                  ...
                  onChange={e => this.handleChange(e, 'checkoutDelay')}
                  placeholder="0"
                />
              </div>
            </div>
