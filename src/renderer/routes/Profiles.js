...
class NewProfiles extends React.Component {
  ...
  addGroup = () => {
    if (!this.state.editing) {
      ...
      this.props.editProfGroup(
        {label: this.state.groupName, value: this.state.groupProfiles, ind: this.state.index},
        this.state.index,
      );
                ...
                {this.props.currentProfiles.length > 0 ? (
                  <div className="table__body">
                    {this.props.currentProfiles.map((profile, i) => (
                      <div
                        className={
                          this.state.groupProfiles.includes(profile.profilename) ? 'table__row selected' : 'table__row'
                        }
                      >
                        <span>
                        ...
                        <span>
                          ...
                          <img
                            onClick={() => this.duplicateProfile(profile, i)}
                            src={duplicateIcon}
                            alt=""
