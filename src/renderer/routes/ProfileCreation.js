    ...
    if (this.refs.cc.value) {
      ...
      if (validator.number(this.refs.cc.value).isValid) {
        ...
        if (validator.number(this.refs.cc.value).card.type !== 'american-express') {
          console.log('Hello??');
          this.refs.cc.value =
            this.refs.cc.value.substr(0, 4) +
            ' ' +
            this.refs.cc.value.substr(4, 4) +
            ' ' +
            this.refs.cc.value.substr(8, 4) +
            ' ' +
            this.refs.cc.value.substr(12);
        } else {
          this.refs.cc.value =
            this.refs.cc.value.substr(0, 4) +
            ' ' +
            this.refs.cc.value.substr(4, 6) +
            ' ' +
            this.refs.cc.value.substr(10);
        }
      }
            ...
            <div className="createprofile-inputs__wrapper">
              <div className="createtask-inputs__section">
                ...
                <div className="input__full">
                  ...
                  <input
                    onChange={e => this.handleChange(e, 'profilename')}
                ...
                <div className="input__split">
                  <div className="input__half">
                    ...
                    <input
                      ...
                      className={
                        this.state.emailChanged ? (this.state.emailComplete ? 'input' : 'input incomplete') : 'input'
                      }
                      placeholder="Email"
                    />
                ...
                <div className="input__split">
                  ...
                  <div className="input__half">
                    ...
                    <Select
                      ...
                      value={
                        this.state.profile.billing.state !== ''
                          ? this.state.billingStates.filter(state => state.value === this.state.profile.billing.state)
                          : this.state.billingStates[0]
                      }
                      onChange={e => {
              ...
              <div className="createtask-inputs__section">
                ...
                <div className="input__split">
                  <div className="input__twurd">
                    <span className="input__text">Address</span>
                    <input
                      onChange={e => this.updateShipping(e, 'address')}
                      value={this.state.profile.shipping.address}
                      type="text"
                      className="input"
                      placeholder="Address"
                    />
                  ...
                  <div className="input__third">
                    <span className="input__text">Apt | Suite</span>
                    <input
                      onChange={e => this.updateShipping(e, 'apt')}
                      value={this.state.profile.shipping.apt}
                      type="text"
                      className="input"
                      placeholder="Apt | Suite"
                    />
                ...
                <div className="input__split">
                  <div className="input__half">
                    <span className="input__text">City</span>
                    <input
                      onChange={e => this.updateShipping(e, 'city')}
                      value={this.state.profile.shipping.city}
                      type="text"
                      className="input"
                      placeholder="City"
                    />
                  ...
                  <div className="input__half">
                    ...
                    <Select
                      ...
                      value={
                        this.state.profile.shipping.state !== ''
                          ? this.state.shippingStates.filter(state => state.value === this.state.profile.shipping.state)
                          : this.state.shippingStates[0]
                      }
                      onChange={e => {
                ...
                <div className="input__split">
                  <div className="input__third">
                    <span className="input__text">Zipcode</span>
                    <input
                      onChange={e => this.updateShipping(e, 'zip')}
                      value={this.state.profile.shipping.zip}
                      type="text"
                      className="input"
                      placeholder="Zip Code"
                    />
              ...
              <div className="createtask-inputs__section">
                  ...
                  <Tilt options={tiltOptions}>
                    <div className={`card ${this.state.profile.cardtype}`}>
                      ...
                      <div className="card--mid">
                        ****-****-****-
                        {this.state.profile.cardnumber.replace(/-|\s/g, '').length > 12
                          ? this.state.profile.cardnumber.replace(/-|\s/g, '').substr(12)
                          : '****'}
                      </div>
                      <div className="card--bottom">
                        <div className="card__info">
                          ...
                          <div className="card__text">
                            {this.state.profile.cardholdername.length > 0
                              ? this.state.profile.cardholdername
                              : 'JOHN DOE'}
                          </div>
                        </div>
                        <div className="card__info">
                          ...
                          <div className="card__text">
                            {this.state.profile.expdate.length > 0 ? this.state.profile.expdate : '01/23'}
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="input__full">
                  ...
                  <input
                    onChange={e => this.handleChange(e, 'cardholdername')}
                    value={this.state.profile.cardholdername}
                    type="text"
                    className="input"
                    placeholder="Name"
                  />
                ...
                <div className="input__split">
                  <div className="input__half">
                    ...
                    <input
                      ...
                      type="text"
                      className={
                        this.state.cardDateChanged ? (this.state.cardDateValid ? 'input' : 'input incomplete') : 'input'
                      }
                      placeholder="01/23"
