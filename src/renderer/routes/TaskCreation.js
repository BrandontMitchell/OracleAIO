...
class TaskCreation extends React.Component {
  ...
  componentDidMount() {
    if (this.props.taskIndex !== null) {
      ...
      if (
        this.props.currentTasks[this.props.taskIndex].siteType === 'shopify-advanced' ||
        this.props.currentTasks[this.props.taskIndex].siteType === 'shopify-safe'
      ) {
        ...
        this.props.currentTasks[this.props.taskIndex].siteType === 'snipes-safe' ||
        this.props.currentTasks[this.props.taskIndex].siteType === 'snipes-normal'
      ) {
      ...
      <>
        ...
        <div className={`page__content ${this.props.editOpen ? 'hidden' : ''}`}>
          ...
          <div className="sites__wrapper">
            <div
              className={
                this.state.siteGroup === 'shopify'
                  ? 'site__wrapper site__wrapper--active shopify--active'
                  : this.state.editing
                  ? 'site__wrapper disabled'
                  : 'site__wrapper shopify'
              }
              onClick={() => {
            ...
            <div
              className={
                this.state.siteGroup === 'supreme'
                  ? 'site__wrapper site__wrapper--active supreme--active'
                  : this.state.editing
                  ? 'site__wrapper disabled'
                  : 'site__wrapper supreme'
              }
              onClick={() => {
            ...
            <div
              className={
                this.state.siteGroup === 'snipes'
                  ? 'site__wrapper site__wrapper--active snipes--active'
                  : this.state.editing
                  ? 'site__wrapper disabled'
                  : 'site__wrapper snipes'
              }
              onClick={() => {
            ...
            <div
              className={
                this.state.siteGroup === 'yeezysupply'
                  ? 'site__wrapper site__wrapper--active yeezy--active'
                  : this.state.editing
                  ? 'site__wrapper disabled'
                  : 'site__wrapper disabled'
              }
