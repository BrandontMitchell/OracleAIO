...
class Tools extends React.Component {
  ...
  checkComplete = () => {
    ...
    if (
      shippingRateName !== '' &&
      ((shippingProfile !== '' && shippingURL !== '' && shippingSite !== '') || (useCustom && customRate !== ''))
    ) {
            ...
            <div className="tools__section">
              ...
              <div className="tools__container">
                <div className="list__select">
                  <h3>Account List</h3>
                  <div
                    onClick={() => this.loadAccountList(null)}
                    className={this.state.editingList ? 'list__item' : 'list__item selected'}
                  >
                    Create
                  </div>
                  {this.props.accountPools.map((pool, i) => (
                    <div
                      onClick={() => this.loadAccountList(i)}
                      className={this.state.listIndex === i ? 'list__item selected' : 'list__item'}
                    >
                  ...
                  <div className="ct-buttons__wrapper">
                    ...
                    <div className="flex--right">
                      {this.state.editingList ? (
                        <Button icon={null} text="Delete List" clickFunction={this.deletePool} color={'red'} />
                      ) : (
                        <></>
                      )}
                      <Button
                        icon={null}
                        text="Save List"
                        clickFunction={this.state.accountsReady ? this.saveAccounts : () => {}}
                        color={this.state.accountsReady ? 'green' : 'green disabled'}
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="tools__section">
              ...
              <div className="tools__container">
                <div className="list__select">
                  <h3>Rate</h3>
                  <div
                    onClick={() => this.loadRate(null)}
                    className={this.state.editingRate ? 'list__item list__item-create' : 'list__item selected-create'}
                  >
                    Create
                  </div>
                  {this.props.shippingRates.map((rate, i) => (
                    <div
                      onClick={() => this.loadRate(i)}
                      className={this.state.rateIndex === i ? 'list__item selected' : 'list__item'}
                    >
                      {rate.name}
                    </div>
                  ))}
                ...
                <div className="list__form">
                        ...
                        <div className="input__split">
                          ...
                          <div className="input__half">
                            ...
                            <Select
                              ...
                              value={this.state.profiles.filter(
                                profile => profile.value === this.state.shippingProfile,
                              )}
                            />
                          </div>
                        </div>
                          ...
                          <div className="switch__wrapper">
                            <label className="form__switch--back">
                              <input
                                ...
                                onChange={() => this.setState({useCustom: !this.state.useCustom})}
                              />
                  ...
                  <div>
                    <div className="ct-buttons__wrapper">
                      ...
                      <div className="flex--right">
                        {this.state.editingRate ? (
                          <Button icon={null} text="Delete Rate" clickFunction={this.deleteRate} color="red" />
                        ) : (
                          <></>
                        )}
                        <Button
                          icon={null}
                          text="Save Rate"
                          clickFunction={this.state.shippingReady ? this.saveRate : () => {}}
                          color={this.state.shippingReady ? 'green' : 'green disabled'}
                        />
                      </div>
                    </div>
                  </div>
