  ...
  async Solve(): Promise<string> {
    return new Promise(async resolve => {
      try {
        ...
        const IframeURL = `https://geo.captcha-delivery.com/captcha/?initialCid=${encodeURIComponent(dd['cid'])}&hash=${
          dd['hsh']
        }&cid=${this.cookie}&t=${dd['t']}&referer=&s=${dd['s']}`;
        ...
        const url = `https://geo.captcha-delivery.com/captcha/check${this.createQuery(
          this.cookie,
          dd['cid'],
          dd['hsh'],
          IframeRes['ip'],
